...
void PveGuaiWuInfoLayer::initPveGuaiWuLayer() {
    ...
    this->textLabel = Label::createWithTTF("jsdasdkahkdjhasjkhdanbcmdsnbfjkahfkjashfkjhjdhfhkajshkfdjashfkjahfksdjhfkdjshfdshbjskhadjsdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdashashdkasj", "fonts/楷体.ttf", 18);
