...
void PveGuaiWu::createGuaiWu(Layer* layer,std::string imageName, cocos2d::Vec2 position) {
    this->preLayer = layer;
    this->guaiWuBtn = ui::Button::create("shushi.png");
    CommonFunc::initButton(this->guaiWuBtn, CC_CALLBACK_2(PveGuaiWu::btnClick, this), screenSize.width/3, position);
